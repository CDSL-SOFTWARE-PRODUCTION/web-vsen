...
return [
    ...
    'supply_selection_analysis' => [
        ...
        'actions' => [
            'refresh' => 'Làm mới',
            'manage_quotes' => 'Cập nhật báo giá NCC',
        ],
        'filters' => [
        ...
        'compare' => [
            ...
            'result_desc' => 'Nguồn dữ liệu lấy trực tiếp từ dòng đơn mua. Giá dùng để so sánh là giá mua dự kiến gần nhất theo SKU + nhà cung cấp, không dùng Bảng giá tham chiếu bán ra.',
