...
return [
    ...
    'supply_selection_analysis' => [
        ...
        'actions' => [
            'refresh' => 'Refresh',
            'manage_quotes' => 'Update supplier quotes',
        ],
        'filters' => [
        ...
        'compare' => [
            ...
            'result_desc' => 'Data comes directly from supply-order lines. Comparison price uses latest planned purchase price by SKU + supplier, not sales reference price lists.',
            ...
            'subcol_unit_price_currency' => 'USD',
            'subcol_total' => 'Total',
        ],
        'sections' => [
            'overview' => 'Overview',
